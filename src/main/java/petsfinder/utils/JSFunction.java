...
public class JSFunction {
	...
	public static void alertLocation(String msg, String url, JspWriter out) {
		/**
		 * Java클래스에서는 JSP의 내장 객체를 사용할 수 없으므로 반드시 매개변수로
		 * 전달받아 사용해야 한다.
		 * 여기서는 화면에 문자열을 출력하기 위해 out 내장 객체를 JspWriter 타입으로
		 * 받은 후 사용하고 있다.
		 */
        try {
            String script = ""  
    ...
    /*
    	앞의 2개의 메소드는 JSP에서 out 내장객체를 통해 Javascript함수를 실행한다.
    	아래는 서블릿에서 JS함수를 실행하기 위해 작성되므로 out 내장객체 대신
    	response 내장객체를 통해 컨텐츠 타입을 설정한 후 JS코드를 출력한다.
     */
